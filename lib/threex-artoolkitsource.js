...
THREEx.ArToolkitSource = function(parameters) {
  ...
  this.parameters = {
    ...
    sourceWidth:
      parameters.sourceWidth !== undefined ? parameters.sourceWidth : 640,
    sourceHeight:
      parameters.sourceHeight !== undefined ? parameters.sourceHeight : 480,
...
THREEx.ArToolkitSource.prototype.init = function(onReady) {
  ...
  this.domElement.style.zIndex = '-2';
  this.domElement.id = 'videoSource';
...
THREEx.ArToolkitSource.prototype._initSourceVideo = function(onReady) {
  ...
  // immediately play webcam on open, after 1 second
  setTimeout(() => domElement.play(), 1000);
...
THREEx.ArToolkitSource.prototype._initSourceWebcam = function(onReady) {
  ...
  if (
    ...
    alert(
      'WebRTC issue! navigator.mediaDevices.enumerateDevices not present in your browser'
    );
  }
    ...
    .then(function(devices) {
      ...
      navigator.getUserMedia(
        ...
        function success(stream) {
          ...
          console.log('video SOURCE', domElement);
