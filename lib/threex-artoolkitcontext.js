...
THREEx.ArToolkitContext = function(parameters) {
  ...
  this.parameters = {
    ...
    canvasWidth:
      parameters.canvasWidth !== undefined ? parameters.canvasWidth : 640,
    canvasHeight:
      parameters.canvasHeight !== undefined ? parameters.canvasHeight : 480,

    // enable image smoothing or not for canvas copy - default to true
    // https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/imageSmoothingEnabled
    imageSmoothingEnabled:
      parameters.imageSmoothingEnabled !== undefined
        ? parameters.imageSmoothingEnabled
        : false,
  };
  ...
  this._projectionAxisTransformMatrix.multiply(
...
THREEx.ArToolkitContext.prototype.init = function(onCompleted) {
  ...
  _this._cameraParameters = new ARCameraParam(
